...
export default function ServicesClientPage({ locale }: { locale: string }) {
              ...
              return (
                ...
                >
                  ...
                  <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '1.5rem', flex: 1 }}>
                    {[1, 2, 3, 4].map((i) => (
                      <li key={i} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.825rem', color: 'hsl(var(--foreground)/0.75)' }}>
                        <CheckCircle size={14} color="hsl(var(--primary))" />
                        {t(`items.${key}.f${i}`)}
                      </li>
                    ))}
                  </ul>
        ...
        <div className="container">
          <div className="glass" style={{ padding: '4rem 2rem', borderRadius: 'var(--radius)', background: 'hsl(var(--primary)/0.08)' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <a href="https://wa.me/994506684823" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp btn-lg">
