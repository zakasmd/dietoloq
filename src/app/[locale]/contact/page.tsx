          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '3rem', alignItems: 'start' }}>
            ...
            >
              ...
              <div className="glass" style={{ padding: '2rem', borderRadius: 'var(--radius)' }}>
                ...
                <a href="https://wa.me/994506684823" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp btn-lg" style={{ width: '100%', justifyContent: 'center' }}>
                  <WaIcon /> WhatsApp-da yaz
                </a>
              </div>
            </motion.div>
          </div>
